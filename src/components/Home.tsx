    ...
    return (
        <section className="relative h-screen flex flex-col justify-center items-center bg-[#0a0510] overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full flex justify-between items-baseline px-6 py-6 z-10">
                ...
                <Link
                    to="/portfolio"
                    className="bg-white text-black text-lg md:text-xl font-normal px-8 py-4 md:px-10 md:py-5 rounded-full transition-colors flex items-center space-x-2 shrink-0 -translate-y-[3px] sm:-translate-y-[10px] md:-translate-y-[18px] lg:-translate-y-[25px]"
